import {
  ...
  DataStore,
  Payload,
} from "https://deno.land/x/assistantlib@v1.0.0-alpha.2/mod.ts";
import {
  connect,
  Redis,
  RedisConnectOptions,
} from "https://deno.land/x/redis@v0.19.0/mod.ts";

export default class RedisStore<K extends string, V extends Base>
